...
from flask_application import application, Session, db
import geojson
from geojson import Feature, FeatureCollection, MultiLineString, Point

from flask_application.WebAppProjects.LACO_SW_TraceApp import QueryEsriRest
from flask_application.WebAppProjects.LACO_SW_TraceApp import TraceSQLQueries
import io
import csv
...
def handletracerequest():
    ...
    if request.args.getlist("blocklnglats"):
        ...
        # flask_application.logger.debug(edgeIDs)
